...
modelViewMatrix.setLookAt(0, 0, 1, 0, 0, 0, 0, 1, 0);
...
const pressArrowLeft = () => {
	modelViewMatrix.translate(0.1, 0, 0);
	main();
};
...
window.onkeydown = e => {
	const { key } = e;
	if (key === "ArrowRight") pressArrowRight();
	if (key === "ArrowLeft") pressArrowLeft();
};
